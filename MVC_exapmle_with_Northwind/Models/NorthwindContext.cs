...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<Lab1011whobuyit> Lab1011whobuyits { get; set; }

    public virtual DbSet<Many> Manies { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=Northwind;Integrated Security=True;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Lab1011whobuyit>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("lab1011whobuyit");
        ...
        {
            entity.HasKey(e => e.ManyId).HasName("PK__many__20C08ACC3F1D3130");

            entity.ToTable("many");

            entity.Property(e => e.ManyId)
                .ValueGeneratedNever()
                .HasColumnName("manyId");
            entity.Property(e => e.ManyData).HasColumnName("manyData");
            entity.Property(e => e.OneId).HasColumnName("oneId");

            entity.HasOne(d => d.One).WithMany(p => p.Manies)
                .HasForeignKey(d => d.OneId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_one_many");
        });

        modelBuilder.Entity<One>(entity =>
        {
            entity.HasKey(e => e.OneId).HasName("PK__one__2D62698CB31D2E83");
            ...
            entity.Property(e => e.OneId)
                .ValueGeneratedNever()
                .HasColumnName("oneId");
            entity.Property(e => e.OneData).HasColumnName("oneData");
        });
